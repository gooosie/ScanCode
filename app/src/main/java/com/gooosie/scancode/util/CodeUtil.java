...
import com.gooosie.scancode.zxing.camera.BitmapLuminanceSource;
import com.gooosie.scancode.zxing.camera.CameraManager;
import com.gooosie.scancode.zxing.decode.DecodeFormatManager;
...
public class CodeUtil {
    ...
    private static final String TAG = CodeUtil.class.getCanonicalName();
...
//            decodeFormats.addAll(DecodeFormatManager.DATA_MATRIX_FORMATS);
     ...
     * @return
     */
    public static Bitmap createQRCodeImage(String text,int w,int h, Bitmap logo) {
    ...
    public static boolean isSupportFlashlight() {
        return CameraManager.isSupportFlashlight();
    }

    public static boolean setLightEnable(boolean isEnable) {
        return CameraManager.get().setLightEnable(isEnable);
    }
}
