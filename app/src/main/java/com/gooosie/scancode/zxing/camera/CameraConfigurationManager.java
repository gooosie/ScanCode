...
final class CameraConfigurationManager {
    public static final String TAG = CameraConfigurationManager.class.getCanonicalName();

    private static final int TEN_DESIRED_ZOOM = 34;
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        Log.d(TAG, "Default preview format: " + mPreviewFormat + '/' + mPreviewFormatString);
        ...
        Point screenResolutionForCamera = new Point(mScreenResolution);
        ...
        Log.d(TAG, "Camera resolution: " + mScreenResolution);
    }
