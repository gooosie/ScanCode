package com.gooosie.scancode.zxing.camera;
...
public class CameraManager {
     ...
     * @throws IOException Indeicates the camera driver failed to open.
     */
    ...
    public static boolean isSupportFlashlight() {
        return FlashlightManager.isSupportFlashlight();
    }

    /**
     * Turn on the flashlight if device supports.
     * @param isEnable True to turn on the flashlight.False to turn off the flashlight.
     * @return true if device supports control of the flashlight.Otherwise return false.
     */
    public boolean setLightEnable(boolean isEnable) {
